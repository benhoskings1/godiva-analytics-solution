create_athlete_tab <- function(admin_panel=FALSE, athlete_select=NULL) {
  shiny::wellPanel(
    # tags$head(
    #   tags$link(rel = "stylesheet", type = "text/css", href = "../www/app_style.css"),
    #   tags$link(rel = "stylesheet", type = "text/css", href = "../www/layouts.css"),
    ...
    tags$div(class="profile_layout",
      tags$div(class="data_container",
        ...
        tags$br(style = "height: 50px; background-color: white"),
        tags$div(class="data_container",
